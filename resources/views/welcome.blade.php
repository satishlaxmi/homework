...
<!-- Mirrored from freshcart.codescandy.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 06:04:56 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
          ...
          <div class="col-md-2 col-xxl-2 text-end d-none d-lg-block">
            ...
            <div class="list-inline">
              ...
              <div class="list-inline-item me-5">
                ...
                <a href="#!" class="text-muted" data-bs-toggle="modal" id="userregiste" data-bs-target="#userModal">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-user">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content p-4">
      ...
      <div class="modal-body">     
      <form method="post" action="{{ route('register_adduser') }}" id="form_register_user">
    @csrf
    ...
    <div class="form-group row mb-0">
        <div class="col-md-6 offset-md-4">
            <button type="submit" id="submit_register" class="btn btn-primary">
                {{ __('Register') }}
            </button>
        </div>
    </div>
...
$('#submit_register').on('click', function(event) {
    ...
    let userInformation = $('#form_register_user').serialize();
    console.log(userInformation);
    $.ajax({
        url: "{{ route('register_adduser') }}",
        type: "post",
        ...
        success: function(response) { 
            if (response.hasOwnProperty('errors')) {
                ...
                let succeessMSg  = response.sucess;
                ...
                Swal.fire(  
                  ...
                  $('.invalid-feedback strong').each(function(){
                    $(this).empty();
                    $('.is-invalid').removeClass('is-invalid');
                  })
                  console.log(succeessMSg); 
            }
        }
    });
});
...
<!-- Mirrored from freshcart.codescandy.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 06:05:35 GMT -->
</html>